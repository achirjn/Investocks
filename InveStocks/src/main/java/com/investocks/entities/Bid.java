...
public class Bid {
    ...
    public Bid(Company company, int price, int quantity, User user) {
    ...
    public Bid(Company company, LocalDateTime placedTime, int price, int quantity, int remainingQty, User user) {
        this.company = company;
